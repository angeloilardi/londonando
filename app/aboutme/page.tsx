    ...
    <>
      <div className="bg-off-white">
        <p>
          ...
          per chi vuole perdersi tra le sue frequentatissime piazze e i numerosi
          mercati o scoprire gli angoli pi&ugrave; nascosti e meno battuti dal
          turismo di massa.
        </p>
        <br />
        <p>
          ...
          fondamentali della storia inglese e non solo. Scopri i Palazzi Reali,
          i giardini privati e i luoghi della vita della compianta Regina
          Elisabetta II, la Regina Vittoria e l&rsquo;indimenticata Lady Diana,
          la Principessa del Popolo.
        </p>
        <br />
        <p>
          Non solo piacevoli passeggiate esterne nella Londra storica e
          culturale o urbana e multietnica, ma anche visite guidate nei musei e
          nelle gallerie pi&ugrave; blasonate d&rsquo;Inghilterra. Lasciati
          ...
          dell&rsquo;arte attraverso alcuni dei quadri degli artisti pi&ugrave;
          importanti di tutti i tempi. Visita il Museo di Storia Naturale con la
          sua famosa galleria dedicata ai dinosauri che incanta e rapisce
          milioni di visitatori grandi e piccini da ogni angolo del globo.
        </p>
        <ReviewsWidget />
      </div>
    </>
